...
export const MockRequestClient = {
  create(overrides?: Partial<RequestClient>): RequestClient {
    return {
      ...
      getGitLog: vi.fn().mockResolvedValue({ available: false, commits: [] }),
      ...
      sendGitPull: vi.fn().mockResolvedValue({ success: false }),
      verifyGitProvider: vi.fn().mockResolvedValue({ success: false }),
      sendGitCreateRemote: vi.fn().mockResolvedValue({ success: false }),
      verifyRemoteComputeTarget: vi.fn().mockResolvedValue({ success: false }),
      setRemoteComputeTarget: vi.fn().mockResolvedValue({ success: false }),
      ...
      publishNotebook: vi.fn().mockResolvedValue({ url: null }),
