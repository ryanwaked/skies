...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <StyleNamespace>
    <InternalTooltipContent
      ...
      className={cn(
        "z-tooltip overflow-hidden rounded-md border bg-popover px-3 py-1.5 text-xs text-popover-foreground shadow-md data-[side=bottom]:slide-in-from-top-1 data-[side=left]:slide-in-from-right-1 data-[side=right]:slide-in-from-left-1 data-[side=top]:slide-in-from-bottom-1",
        className,
      )}
      {...props}
    />
