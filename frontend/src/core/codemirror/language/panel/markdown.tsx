    ...
    <div className="flex flex-col gap-3.5">
      <section className="flex flex-col gap-0.5">
        <header className="flex items-center gap-1">
          <code className="text-xs px-1 py-0.5 bg-muted rounded">r</code>
          <span className="font-semibold">Raw String</span>
        </header>
        <p className="text-sm text-muted-foreground">
          Write LaTeX without escaping special characters
        </p>
        <pre className="text-xs bg-muted p-2 rounded">\alpha \beta</pre>
      </section>

      <section className="flex flex-col gap-0.5">
        <header className="flex items-center gap-1">
          <code className="text-xs px-1 py-0.5 bg-muted rounded">f</code>
